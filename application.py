...
@application.route("/predict_page", methods=['GET'])
@cross_origin()
def predict_page():
    return render_template('predict.html')


@application.route("/train_page", methods=['GET'])
@cross_origin()
def train_page():
...
@application.route("/viewtrainedfile", methods=['GET'])
@cross_origin()
def viewTraining():
...
@application.route("/viewpredictedfile", methods=['GET'])
@cross_origin()
def viewprediction():
